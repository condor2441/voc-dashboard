...
window.VOC_MODELS['op15'] = {
    ...
    displayInsights: [
      '포지셔닝: 글로벌 프리미엄 볼륨 세그먼트($600 대). 배터리·디스플레이·아이케어 극우수(BSI +101, DSI +76.2) 강조 전략. 카메라 센서 다운그레이드는 세트 완성도 하락 주요 이슈. 지역별 반응 차별화(글로벌 neg 높음, 중국 긍정 우수).',
      '강점: Tom\'s Guide 배터리 역대 최고 25h13m 실증(BSI +101, n=16 100% 긍정). 2160Hz PWM·TÜV 5.0 아이케어 글로벌 극찬(Display_Eyecare n=17 100% 긍정). 165Hz LTPO·4500nit 밝기 기대 충족. 배터리 세트의 핵심 우위.',
      '약점: 카메라 센서 다운그레이드(1/1.4"→1/1.56") 글로벌 불만 75%(CSI −8.5, n=21 neg 48%). Hasselblad 종료로 프리미엄 이미징 포지션 약화. 발열(4K 5분 50°C, TRI 12.3) VC 냉각 효과 의문. 카메라·발열 병존 약점 → 배터리만으로 프리미엄 정당화 미흡.',
      '세트 평가: 배터리는 업계 최고 입증, 디스플레이는 아이케어 리더. 카메라는 명백한 포지션 후퇴. 지역별 선호도 편차(중국 LUMO 호평, 글로벌 Hasselblad 미스 강함).'
    ],

    productInsights: [
      '패널 공급 현황: BOE T10 LTPO AMOLED 탑재 확인. 6.82" 1.5K(2780×1264)·165Hz LTPO·4500nit 피크·2160Hz PWM·DC 듀얼 디밍·TÜV 明眸护眼 5.0. SDC는 OnePlus 일부 모델 공급 경험 있음(과거). 현재 BOE가 주공급. 1.5K 해상도 트레이드오프 지역별 반응 상이(글로벌 일부 neg).',
      '디스플레이 VOC 해석(SDC 시각): DSI +76.2(글로벌) · 아이케어 극우수(Display_Eyecare n=17, 100% 긍정) · 2160Hz PWM·0.5nit 최저 밝기 데이터 기반 글로벌 호평(감정 극극호). 그러나 카메라 갭(CSI −8.5)·발열 약점(TRI 12.3) 병존. 디스플레이만으로는 프리미엄 정당화 미흡 → 시스템 솔루션 필요.',
      '중국 패널 경쟁사 동향: BOE T10는 아이케어(TÜV 5.0) 경쟁의 표준화 추세 주도. CSOT·Visionox의 고주파 PWM(3000Hz+) 추격. 중국 내 "明眸护眼" 마켓 성장으로 경쟁 격화. SDC 아이케어 기술(저밝기·고주파 PWM 조합)이 경쟁 차별화 영역.',
      'SDC 공급 기회 및 차별화: OnePlus 15 차기 모델(2026년 하반) 재수주 경합: (1) TÜV 5.0 유지 시 SDC "3000Hz 초고주파 PWM" 강조, (2) 저밝기(0.3nit) 극한까지 내려가는 기술, (3) 165Hz 유지 시 저전력 LTPO 우위(경쟁사 대비 20% 배터리 효율 개선 가능). 글로벌 프리미엄 볼륨 세그먼트 최대 타겟 → 아이케어 마켓 성장 활용.',
      'SDC 전략 제언: OnePlus는 글로벌 아이케어 시장 성장의 "얼리 어답터" → 165Hz·2160Hz PWM·TÜV 5.0 조합 = 차별화 가능 영역. BOE T10 대비 SDC의 "저밝기 극한 기술(0.3nit) + 초고주파 PWM(3000Hz+) + 글로벌 TÜV 지원" 강점 소구. 카메라·발열 약점 보완을 위해 디스플레이 아이케어 우위로 "프리미엄 웰니스" 포지셔닝 제안 → 차세대 수주 확률 높음.'
    ],
