...
window.VOC_MODELS['s26plus'] = {
    ...
    displayInsights: [
      '포지셔닝: 기대갭 극심한 모델(SEGI −2.1, n=47). 디스플레이 밝기(2600nit, 89% 호평)는 우수하나 480Hz PWM(75% 부정) · 카메라 정체(43% 만족) · 충전기 미포함(62% 만족)으로 $1,099 프리미엘 가격 정당성 훼손. 중국·글로벌 모두 "너무 안전한" 평가(DSI 0.18, 거의 중립).',
      '강점 한계: 2600nit 밝기와 항반사 코팅 극찬(72% 호평)이 유일한 명확 강점. 그러나 PWM 저주파 논란과 겹쳐 디스플레이 완성도 의문. 보조 강점 부재 상황.',
      '약점 집중: (1) 480Hz PWM 눈피로(중국 강불만 5건), (2) S25+ 동일 카메라 HW, (3) 45W 충전기 별도 구매 = 가격 정당성 3중 결함. 기대갭이 누적되며 성숙기 부정 60% 도달.',
      '경쟁 포지션: 같은 6.7" 프리미엘 세그먼트에서 OPPO Find X9 Pro(3600nit + 3840Hz PWM + 카메라혁신)와 비교 시 디스플레이·카메라·충전 모두 뒤처짐. 차세대는 PWM 2160Hz+, 카메라 혁신, 충전기 번들화 동시 진행으로 "완성도" 이미지 회복 필수.'
    ],
