...
window.VOC_MODELS['s26plus'] = {
    ...
    displayInsights: [
      '배터리: 45W 충전(별도 구매) + 4900mAh는 부분부합 — 차세대에서 충전기 번들화 + 50W 이상 도입으로 마케팅 완성도 제고 필수.',
      '게이밍: 49.5°C 게임 발열 + Thermal 부정 지적 — GEI/TRI 미산출하나 발열 개선이 차세대 게이밍 경쟁력 핵심.',
      '카메라: S25+ 동일 HW + 기대갭 극심 → CSI 미계산하나 50MP→108MP 센서 또는 혁신적 AI 처리로 차별화 필수.',
      '가격: SEGI −2.1(기대갭 심화) + 29% 만족도 — $1,099 프리미엘 가격과 카메라·충전기 미포함의 불일치가 최대 불만. "너무 안전한" 평론 반영.',
      'SoC: SD 8 Elite Gen 5 성능은 우수하나, 프리미엘 가격 정당화 부족 — 카메라·충전 혁신과 병렬화로 종합 강점 강화 필수.'
    ],
