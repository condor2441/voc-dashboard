...
window.VOC_MODELS['iqoo15'] = {
    ...
    displayInsights: [
      '배터리: BSI +49.5 · 7000mAh로 2.5일 사용 체감. 무선충전 첫 도입(100W) 호평이나 유선 100W 퇴보(전작 120W)는 강불만 지속. 次세대에서 ≥120W 복원 권장.',
      '게이밍: GEI +52.1 · 4시간 연속 게이밍 40°C 이내 유지 확인(n=10). 발열 강점. 144fps 안정성 극찬. 열 관리 경쟁력 명확.',
      '카메라: CSI +41.2 · 주카메라 우수(75%긍)이나 셀카 납작화·4K뭉개짐 이슈(기대갭 50%). 광학 튜닝 개선 필수.',
      '가격: 5999위안 프리미엘 게이밍 세그먼트 정가. 성능·배터리 강점 정당화. 중국 시장 기대감 높음(긍정 70%).',
