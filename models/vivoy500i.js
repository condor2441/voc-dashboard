...
window.VOC_MODELS['vivoy500i'] = {
    ...
    displayInsights: [
      'BSI 0.68(중상) | 3840Hz PWM + DC 하이브리드로 저밝기 완전 무깜빡임 달성. 눈피로 거의 없음. 차세대: LTPO 120Hz 도입으로 배터리 효율 추가 개선.',
      'GEI 해당 없음 | 1200nits 피크 밝기로 야외 가시성 충분(n=14, 78% 긍정). 1520×720 HD+ 해상도는 6.75" 대화면에서 아쉬움. 차세대: 1620×720 또는 1920×1080 FHD 진입 검토.',
      'TRI 게이밍 발열 심함 | Snapdragon 4 Gen 2로 게이밍 30분 후 스로틀링. LCD 패널이지만 색감·응답속도 우수. 차세대: Snapdragon 6 Gen 2 고려로 발열 40% 감소.',
      'PriceValue 16건 중 긍정 13건 (81%) | 1499위안 가성비 극찬. 배송·학생층 대상 만족도 높음. 하지만 카메라·게이밍 기대 불일치. 차세대: 카메라 마케팅 최소화.',
      'SoC Snapdragon 4 Gen 2 성능 한계 | 일반 사용 우수하나 극한 게이밍(30분+) 발열 심함. 배터리 효율성은 우수. 차세대: Snapdragon 6 Gen 2로 성능 30% 향상하되 가격 유지.'
    ],

    productInsights: [
      'Tianma a-Si LCD 탑재(추정). SDC 기술 도입 기회: 3840Hz PWM 유지하되 LTPO 120Hz 도입으로 배터리 효율 강화. 커뮤니티 댓글 "배터리 폰"으로 정체성 강화.',
      'Y500i → Y600 파생 전략: Y500i는 "배터리·내구성 강점" 포지셔닝 명확화(배송/학생), Y600은 게이밍·카메라 개선으로 다용도 세그먼트 공략.',
      'CSOT·BOE LCD 공급 경쟁 심화. SDC는 3840Hz PWM + DC 조광 고도화로 LCD 차별화. 2026 배터리 강화 전략으로 배송업 전용폰 마케팅.',
      '카메라 50MP "과판매" 확정. 저광량 환경 처리 약함(CSI 0.35 경고). 마케팅에서 "50MP 메인"이 아닌 "배터리·내구성" 강조 필수. 카메라 전문 리뷰 예방.',
      'Y500i는 세그먼트 정확성 높음(배송·학생·가치소비자). 차기 Y600은 게이밍 관심층 포함하려면 Snapdragon 6 Gen 2 + f/1.6 카메라 + 발열 관리 필수. 3분할 전략: Y500(배터리중심)·Y600(밸런스)·Y700(게이밍).'
    ],
