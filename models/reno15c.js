...
window.VOC_MODELS['reno15c'] = {
    ...
    displayInsights: [
      '포지셔닝 이원화 위험: 동일 모델명이지만 실질 다른 제품(중국 SD7G4+1.5K vs 인도 SD6G1+FHD+). 배터리·충전(BSI +130, 극강)은 양 시장 공통 강점이나 성능·카메라·디스플레이 사양 차이 극심(variant_difference). 중국판은 가성비 극찬(2899위안) vs 인도판은 가치 의문(₹37,999). 낮은 표본(n=32, 지역편중 62%)으로 참고용 평가.',
      '양 시장 강점: 배터리 6500/7000mAh + 80W SuperVOOC + 40-54분 완충은 공통 최강점(BSI +130, 10시간 SOT·2일 사용 달성). OPPO Reno 시그니처 경량·얇음·IP69(195g, 7.99mm) 디자인도 양 시장 호평. 이 두 강점만으로는 지역판 격차 상쇄 불가.',
      '지역간 약점 격차: (1) 중국 SD7G4(쾌적) vs 인도 SD6G1(₹37,999 대비 심각 부족·강불만 3건), (2) 중국 1.5K OLED(호평) vs 인도 FHD+ 야외 1200nit HBM(부족·강불만 3건), (3) 중국 50MP 망원(호평) vs 인도 매크로만(실망). 신뢰도 손상 극심.',
      '경쟁 포지션: 중국판은 2899위안 가성비로 경쟁사 추격(동급 대비 1.5K·망원 차별화). 인도판은 ₹37,999에 SD6G1+FHD+은 경쟁사 대비 과가격(realme/iQOO는 동가격에 상위 칩셋). 지역별 전략 통일화 필수.',
      '신뢰도 위협: Reno 시리즈는 "Design Flagship" 이미지로 글로벌 신뢰도 중요. 지역판 사양 이원화는 장기 신뢰도 훼손. 차세대는 양 시장 동등 사양(SD8+, 1.5K, 카메라 통일)으로 "One Design" 컨셉 강화 필수.'
    ],
