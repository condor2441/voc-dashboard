...
window.VOC_MODELS['vivox300ultra'] = {
    ...
    displayInsights: [
      'DSI +21.5 | 2K 2160×2400 + 1946nit 글로벌로 야외 가시성 극상. 낮은 해상도 선택이 배터리 효율과 트레이드오프. 차세대: QHD+ 2560×1600 진입 검토 필요.',
      '눈피로 관리 7건/7건 긍정 (100%) | 2160Hz PWM + DC 전환 선택 가능. 전문가 워크플로우(사진/영상 제작) 최적화. 차세대: 1nit 최저 밝기 추가 + 10000K 선택지 확대.',
      'Zeiss Master Color 색감 | Zeiss 협업 튜닝으로 색정확도 극상. 사진 전문가 만족도 높음. 하지만 알고리즘 간섭 우려 9% 보고. 차세대: 색감 자유도 선택지 추가(Standard/Vivid/Pro).',
      'PriceValue 8건 중 부정 7건 (87.5%) | €600 카메라킷 가격 저항감 극심. 글로벌 세그먼트 포지셔닝 오류. 차세대: 기본 모델 €500대로 진입하거나 카메라킷 분리 판매.',
      'SoC Snapdragon 8 Elite Gen5 + UFS 4.0 | 성능 충분하나 4K120 HDR 인코딩 시 발열 이슈 4건 보고. 차세대: 프로 비디오 모드에서 25fps 제한 또는 냉각 강화.'
    ],

    productInsights: [
      'BOE Q10 Plus 탑재(확정). SDC 기술 도입 기회: Zeiss 협업 튜닝 고도화 + 2K→QHD+ 해상도 상향. 이미징 플래그십 카테고리 차별화.',
      'X300 Ultra → X310 Ultra 파생 전략: X300은 "200MP 카메라 최강" 포지셔닝, X310은 AI 영상 편집 추가로 콘텐츠 크리에이터 전용화.',
      'Huawei·Apple 경쟁사 이미징 고도화. SDC는 고해상도 디스플레이 + Zeiss 협업으로 차별화. 2K 유지하되 색감/밝기 고도화 우선.',
      '카메라 모듈 두께 불만 23%(n=13). 두께 8.19mm + 카메라 유격으로 케이스 호환 문제. 차세대: 플러시 디자인 또는 카메라 모듈화 검토 필수.',
      'X300 Ultra는 카메라 강점만으로 프리미엄 이미징 세그먼트 확보. 글로벌 가격 재전략(€450 기본 + €150 카메라킷)으로 가성비 개선. 중국 시장 1-2개월 선행 출시 강화.'
    ],
