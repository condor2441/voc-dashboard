...
window.VOC_MODELS['s26u'] = {
    ...
    displayInsights: [
      '포지셔닝 역전: 출시초기 극찬(+16) → 성숙기 급락(−22) 극명한 사례. Privacy Display 혁신은 차별화이나 사용성 트레이드오프 극심(텍스트 흐릿함·두통·눈피로 강불만 47%). 60W 충전(BSI +80)과 21% 발열 개선이 불만을 상쇄 불능 — 기술혁신이 신뢰 훼손.',
      '강점 명확: (1) 60W 충전 + 25W 무선(43분 완충, 100% 호평), (2) 21% 산열 개선(TRI −12, 게이밍 온도 안정), (3) SD 8 Elite Gen 5 성능 우수. 세 강점이 충전·열관리·성능 영역 완벽 구성.',
      '약점 치명: Privacy Display 초기 혁신극찬 → 성숙기 강불만 폭증(DSI −22) = 하드웨어 기술 미완성 + 소프트웨어 최적화 부재. 삼성 공식 인정(3/17 "일부 각도 밝기 변화")도 신뢰 회복 미흡. 카메라도 F1.4 개선에도 "의미 없음" 평가(−8).',
      '경쟁 포지션: Privacy Display 혁신은 유일하나 불완전. iPhone 17 Pro(3000nit, DSI 0.62, 초저주파 PWM)와 비교 시 기술 신뢰도에서 뒤짐. Find X9 Pro(3600nit + 3840Hz PWM, DSI +75)는 완성된 혁신. 차세대는 기술 완성도 95%+ 검증 후 출시 필수.',
      'SoC와 부분강점: SD 8 Elite Gen 5가 Privacy Display 불만을 부분 상쇄하는 유일한 우위점. 그러나 SoC만으로는 기술혁신 신뢰 회복 불충분. 차세대 전략은 Privacy Display 2.0(완성도) + 카메라 혁신 병렬화로 "진정한 혁신" 이미지 재구축.'
    ],
