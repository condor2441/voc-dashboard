...
window.VOC_MODELS['ip17pro'] = {
    ...
    displayInsights: [
      '배터리: 배터리 실측 편차 지속(사용패턴 편차) — 일반사용자 만족(68% 긍정) 하나, 헤비유저 부족 호소. 차세대 3800mAh 이상으로 세그먼트 차별화 필수.',
      '게이밍: GEI 미산출하나 TRI 0.15(극히 낮음) + 냉각 40% 감소 + 증기실 냉각 극찬 — 게이밍 온도 관리 최강. 차세대 액체냉각 검토.',
      '카메라: CSI 0.58(긍정) + 48MP·8배 줌·야경 품질 우수 — 다만 iOS 26 업데이트 후 카메라 앱 안정성 저하(post_update_worsened) 심각. 차세대에서 iOS 최적화 필수.',
      '가격: 기본형과 디스플레이 동일 + Pro 가격 $1,100 → Pro 세그먼트 차별화 부족 지적 심화. 향후 A19 Pro만으로는 불충분 — 배터리·냉각 차별화 강조 필수.',
      'SoC: A19 Pro 성능 우수(100% 긍정) + 게이밍 안정성 확인 — 이것이 Pro 가치의 유일한 명확 포인트. 차세대에서도 Pro-only chipset 전략 유지하되, 기본형과의 성능 격차 확대 필수.'
    ],
