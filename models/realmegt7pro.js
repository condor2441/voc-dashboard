...
window.VOC_MODELS['realmegt7pro'] = {
    ...
    displayInsights: [
      '포지셔닝: Snapdragon 8 Elite 첫 탑재 게이밍 플래그십(2024년 11월). 성능·디스플레이·배터리 3각형(GEI 0.58, DSI 0.62, BSI 0.54). 카메라는 "선도적" 소구 대비 약점 명확. 출시 17개월 경과로 차세대 관심 이동(n=78) → 성숙기 데이터 신뢰도 높음.',
      '강점: 6000nit Eco² 기술 100% 극찬(n=20 100% 긍정, Display_Brightness), 120W 14분 50% 극고속충전 100% 긍정(n=12). 원신 144fps 안정(GEI 0.58). SD8 Elite 성능 입증 완료(n=13 85% 긍정). 스펙 대비 가격 경쟁력 양호.',
      '약점: 8MP 초광각 명백한 약점(neg 67%, n=12 카메라 부정 7/12). 극한 게이밍 발열(neg 71%, n=7). "선도적 이미징" 소구 대비 기대갭 3배. 3년 OS 지원(경쟁사 대비 단점). 카메라·발열은 완제품 타협점.',
      '세트 평가: 성능·디스플레이·배터리는 동급 최우수. 카메라 약점 명확하나 게이밍폰 타겟층(n=13 성능 85% 긍정)은 우선순위 낮음. 가성비 세그먼트에서 완성도 높음.'
    ],
