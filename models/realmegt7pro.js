...
window.VOC_MODELS['realmegt7pro'] = {
    ...
    productInsights: [
      '배터리 강점 강화. 6500mAh + 120W는 경쟁사(OPPO K17 5000mAh) 대비 우위 명확(2.5일 vs 1.8일) · 가성비 세그먼트 배터리 리더십 확보.',
      '발열 투명성 필수. 극한 게이밍 발열 불만 16% 수준 → 펌웨어 최적화로 개선 시 게이밍폰 신뢰도 회복 · 마케팅에서 "냉각 케이스 권장" 사전 안내 필수.',
      '카메라 재포지셔닝 권고. "선도적 이미징" 마케팅 축소 · 8MP 초광각 약점 명확(사용자 "8MP는 낡음" 평가) · 다음 세대 48MP 초광각 + 3배 망원렌즈 추가로 이미징 강점 구축.',
      '소프트웨어 지원 기간 연장. 3년 OS 업데이트는 경쟁사(Samsung 5년·Apple 7년) 대비 단점 · 차세대에서 4년 이상 확보 권장.',
      'SDC 디스플레이 진입 기회. 6000nits Eco² + 3840Hz PWM + 120Hz = 업계 최고 밝기 세그먼트 · 경쟁사(iQOO 15) 공급사 BOE 비교 시 SDC 고부가 기술 경쟁 가능성.'
    ],
