...
window.VOC_MODELS['findx9pro'] = {
    ...
    displayInsights: [
      '배터리: BSI +115(극강) + 7500mAh + 21:57h(글로벌 최고 기록) = 공통 최강 강점. 실리콘카본 배터리 180사이클 ±12% 용량분산 신규이슈(커뮤니티 샘플) 주의. 차세대 CATL 배터리 또는 세라믹 코팅 강화 권고.',
      '게이밍: GEI 미산출하나 TRI 34(중단계 발열위험) + Dimensity 9500 throttling 50% — 게이밍 성능은 일상 쾌적하나 스트레스 테스트에서 성능 저하 확인. 차세대 액체냉각 강화 필수.',
      '카메라: CSI −12(기대갭 주의) + 200MP Hasselblad 4K 120fps는 글로벌 극찬(100%) vs 중국 미흡(33%) — 지역간 기대갭 극심. 글로벌은 화질 우수, 중국은 대초점·야경 불만. 차세대 초점 정확도·야경 최적화 필수.',
      '가격: 중국 5299원/글로벌 $1,199는 가성비 의문(기대갭 심화). 글로벌은 디스플레이·배터리 강점 정당화, 중국은 카메라갭·발열이 가격 적정성 훼손. 차세대 가격 재조정 또는 스펙 차별화 필수.',
      'SoC: Dimensity 9500은 일상 우수하나 발열·throttling 문제(TRI 34) = 차세대에서 Dimensity 9600 또는 자체 칩셋 강화 권고. 특히 중국 발열 평가(42.6°C) 반영하여 냉각 아키텍처 재설계 필요.'
    ],
