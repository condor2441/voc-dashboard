...
window.VOC_MODELS['s26'] = {
    ...
    displayInsights: [
      '배터리: BSI +46.0 + 75% 만족도로 효율 개선 체감. S22 대비 발열 해결 극찬. 차세대 30W+ 충전 도입으로 포지셔닝 강화 필수.',
      '게이밍: GEI 미산출하나 TRI 8.2(낮음) — 발열 관리 우수. 게이머 니즈는 높은 PWM 주사율 병렬화로 차이 부각.',
      '카메라: CSI −12.5 + 22.2% 만족도로 4세대 동일 HW의 신뢰 하락 확인. S27에서 50MP→108MP 센서 업그레이드 또는 computational 혁신 필수.',
      '가격: PriceValue 1/3 긍정(33%) — 7.9mm 컴팩트 프리미엄은 인정하나, 25W 충전·동일 카메라가 가격 정당성 훼손. 경량화 가치 재포지셔닝 권고.',
      'SoC: SD 8 Elite Gen 5는 성능 우위 확인(100% 긍정) — 다만 중국시장 Exynos 2600 변형으로 인한 성능 편차 우려. 차기 세대에서 글로벌 동일 칩셋 사용 권고.'
    ],

    productInsights: [
      '디스플레이 공급사 현황: Samsung Display 자사 패널 탑재 확인(LTPO AMOLED 2X, 6.3"). SDC 지위 확고.',
      '진입 기회: 480Hz PWM 미흡이 차세대 개선 포인트 — BOE/CSOT 2160Hz+ DC 디밍 주장 활용하면 S27+에서 SDC는 2160Hz PWM 또는 하이브리드 DC 지원으로 "눈건강 인증" 마케팅 기회 확보.',
      '대응 전략: (a) 2160Hz+ PWM 또는 DC 디밍 하이브리드 탑재, (b) 30W+ 충전 위상 강화, (c) 카메라 HW 업그레이드(108MP 센서) → 디스플레이·배터리·카메라 삼각형 차별화로 "완성된 컴팩트 플래그십" 재정의.',
      '경쟁 위협: OnePlus/Honor/OPPO 2160–3000Hz PWM 주장으로 "눈건강" 주도권 장악. Xiaomi 30W+ 충전 하한가 공세. Samsung은 기술 추격 필수.',
      '차기 세대 로드맵: S27(2026.03) → 30W 충전, 2160Hz PWM, 50MP→108MP 센서, Exynos 2700 글로벌 통일화. 컴팩트 세그먼트에서 "기술 혁신" 이미지 회복.'
    ],
