...
window.VOC_MODELS['redmiturbo5'] = {
    ...
    productInsights: [
      '배터리 강점 극대화. 7560mAh + 100W + 50W 무선 = 경쟁사(OPPO K17 5000mAh, iQOO Z9 Turbo 5500mAh) 대비 압도적 우위(2.5일 vs 1.8일) · 가성비 세그먼트 배터리 리더십 확고.',
      '카메라 개선 긴급. IMX882 저광량 노이즈 심함 · 8MP 초광각 기대갭 명확(neg 82%) · 유일한 약점이 전체 이미지 훼손 · 다음 세대 64MP 초광각(f/2.2) + 3배 망원 추가 필수.',
      '발열 투명성 강화. 극한 고화질 게이밍(120fps Genshin) 시 49.9°C 도달 확인 · 현재 후기는 긍정적이나 마케팅에서 "냉각 케이스 권장" 사전 안내 필수 → 기대관리 · A/S 신뢰도 회복.',
      '가성비 포지셔닝 강화. Dimensity 9300 + 7560mAh + 3500nit DSI 0.80 = 가성비 세그먼트 최강 조합 · "게이머 필수" 마케팅 권장 · 글로벌 시장 진출 시 가성비 강점 활용.',
      'SDC 디스플레이 진입 기회. 3500nit 피크 + DC + 3840Hz PWM + 120Hz = 고부가 가성비 세그먼트 · BOE 또는 CSOT 공급 중 SDC 대체 가능성. 글로벌 가성비 마켓 성장 고려.'
    ],
