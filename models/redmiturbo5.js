...
window.VOC_MODELS['redmiturbo5'] = {
    ...
    displayInsights: [
      '포지셔닝: 가성비 게이밍 플래그십(2026년 1월 출시, n=72 중국 63%). 성능·배터리·디스플레이 극강(GEI 0.76, BSI 0.71, DSI 0.80) 대신 카메라만 유일 약점. Dimensity 9300 Ultra + 3500nit + 7560mAh 스펙 대비 가성비 극강(긍정 100%).',
      '강점: 3500nit 극밝음 100% 극찬(n=13), 무깜빡임 기술(DC+3840Hz PWM) 100% 극찬(n=10 Display_Eyecare), 7560mAh 초대용량 2.5일 극찬(n=13 85% 긍정), Genshin 60fps 안정, 100W 30분 완충 극고속. 게이머층 만족도 극높음.',
      '약점: 카메라 약점 유일이자 명확(neg 82% 극심). 50MP IMX882 저광량 노이즈 심함(n=11 neg 82%), 8MP 초광각 "낡음" 평가. 극한 게이밍 발열 49.9°C. 카메라만으로 세트 완성도 저하. 다음 세대 필수 개선 항목.',
      '세트 평가: 게이밍·배터리·디스플레이는 동급 최우수. 카메라는 완전 타협(가성비 세그먼트 스펙 표준). 실사용 만족도(n=72) 타겟층 정확성·기대관리 우수. 글로벌 VOC 상대적 낮음(n=27) → 글로벌 신뢰성 추적 필요.'
    ],
