...
window.VOC_MODELS['vivoX300s'] = {
    ...
    displayInsights: [
      'DSI +68.3 | 144Hz 고주사율 + 2160Hz PWM으로 게이밍·스크롤 부드러움 극대. 눈피로 관리 업계 최고. 차세대: 165Hz 도입으로 경쟁사 차별화.',
      'GEI +59.8 | 4500nit 로컬·2000nit 글로벌로 야외 가시성 극상. 명암비 우수로 게이밍 체감 품질 향상. 차세대: 로컬 5000nit으로 삼성 경쟁사 추월.',
      'TRI 불만수 20% | 고부하 게이밍 30분 후 43.2°C 발열로 throttling 보고. 144Hz 고주사율 + Dimensity 9500 조합의 열설계 미흡. 차세대: 냉각 시스템 50% 강화 필수.',
      'PriceValue 2건/2건 긍정 (100%) | 4499위안 가격대비 144Hz + 7100mAh 조합 가성비 극찬. 프리미엄 기대치는 충족하나 가성비로 더 강함. 차세대: 4999위안대 진입으로 플래그십 재포지셔닝.',
      'SoC Dimensity 9500 | 왕자영예 풀프레임, 원신 안정적 구동. 게이밍 성능은 업계 1위. 하지만 30분 후 throttling으로 장시간 게이밍 제약. 차세대: 그래픽 메모리 12GB + 냉각 강화.'
    ],

    productInsights: [
      'BOE LTPO 144Hz AMOLED 탑재(확정). SDC 기술 도입 기회: 2160Hz PWM + 144Hz LTPO 결합 고도화로 eye-care 카테고리 강화. 중국 게이밍폰 시장 리드.',
      'X300s → X400 파생 전략: 차세대 X400은 165Hz LTPO + 냉각 강화로 플래그십 상향. X300s는 "성능 게이밍" 수직 포지셔닝 확립.',
      'CSOT·Tianma 경쟁사 고주사율 공급 확대. SDC는 2160Hz PWM + 1nit 최저 밝기 조합으로 차별화. 2026 중국 OEM 14개사 고주사율 다중 공급.',
      '발열 관리 실패 극복 필수(TRI 보정값). Dimensity 9500의 높은 TDP + 144Hz 고주사율 조합. 차세대: Dimensity 9600 또는 Snapdragon 8 Elite 고려로 발열 30% 감소.',
      '대용량 배터리(7100mAh) + 고주사율 게이밍폰 시장 기회. 게이머 대상 "2일 배터리 + 144Hz" 마케팅 강화. X300s FE 또는 X300 Max 파생 검토로 가성비 세그먼트 확보.'
    ],
