...
window.VOC_MODELS['vivoX300s'] = {
    ...
    displayInsights: [
      '세트 포지셔닝 강함 | 게이밍 폰으로 명확한 타겟(게이머) 정확성. 긍정 72.8% vs 부정 13%로 세그먼트 기대 충족. 144Hz 고주사율+7100mAh 초대용량 조합이 중국 게이밍폰 시장 신기준 설정.',
      '완제품 강점 2개 | GEI +59.8(144Hz 부드러움+4500nit 명암비), BSI +72(7100mAh 배터리 1-2일 극찬). 게이밍+배터리 양축 우수로 게이머 타겟층 만족도 극대. 다만 발열(5건 중 부정 4건, 원신 30분 43.2°C)이 장시간 게이밍 제약.',
      '세그먼트 약점 심각 | 기기 두께 2건 부정(8.5mm 두껍다는 불만), TRI 고부하 발열 throttling. 144Hz 고주사율+Dimensity 9500 고성능 조합이 열설계 미흡. 30분 이상 게이밍 시 성능 저하로 플래그십 게이밍폰 명성 저해.',
      '세그먼트 내 차별화 | 2160Hz PWM 눈피로 감소(2건 100% 긍정), 4500nit 로컬 밝기(7건 100% 긍정)는 BOE의 역량 입증. 하지만 기기 두께·발열 문제로 경쟁사(OnePlus·ASUS ROG) 대비 핸드폰 사용성 약함.',
      '마켓 포지션 위험 | 가성비(2건 100% 긍정)로 강하지만 게이밍폰으로서 발열 약점이 장기 신뢰도 침식 위험. 성숙기(2026.04)에서 발열 이슈 6건 중 부정 8건으로 악화 추세. 차세대는 냉각 강화 필수.'
    ],

    productInsights: [
      'BOE LTPO 144Hz AMOLED 탑재(확정). 6.78" QHD+ 1260×2800 / 144Hz LTPO / 2160Hz PWM + DC 디밍 / 4500nit 로컬. DSI +68.3 극상 — BOE가 vivo 고급 라인업 주공급자로 강세. SDC는 이 세그먼트에서 기공급 전무. 중국 고급폰 시장에서 경쟁력 극도로 제한.',
      '디스플레이 VOC 해석(SDC 시각): GEI +59.8 / 144Hz 부드러움 극찬(8건 100%) / 2160Hz PWM 눈피로 감소(2건 100%) / 4500nit 야외 극상(7건 100%). 하지만 TRI 미공개 상황에서 고주사율+고밝기 조합의 발열(43.2°C 게임 30분)로 인해 디스플레이 방열 설계 한계 보임. SDC가 이를 해결하면 강력한 대체 공급 기회.',
      '중국 경쟁사 현황: BOE(X300s) / CSOT(고주사율 확산) / Visionox(Oppo 독점). 고주사율+저눈피로 세그먼트는 BOE 독점에 가까움. 2160Hz PWM은 더 이상 차별화 아님. SDC는 3840Hz PWM 또는 제로 플리커 기술로 새로운 차별화 필요.',
      'SDC 공급 차별화 포인트: ① 144Hz LTPO 유지 + 3840Hz PWM 도입 / ② 로컬 5000nit 달성으로 BOE 추월 / ③ 발열 최소화 패널 설계(VC Chamber 통합) / ④ Dimensity 9600 최적화 색감 튜닝. X300s의 41-42°C 게임 발열은 SoC+디스플레이 협력 설계로 개선 가능.',
      'vivo 중장기 전략: X300s(게이밍 중심) → X400(플래그십 상향) → X300 Max(배터리+퍼포먼스)의 포트폴리오. SDC는 X400 수주 목표로 3840Hz PWM + 165Hz LTPO + 5000nit 로컬 패널 제안. 대용량 배터리(7100mAh) 효율 극대화로 차별화. 중국 게이밍폰 시장 기회 재진입.'
    ],
