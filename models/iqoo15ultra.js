...
window.VOC_MODELS['iqoo15ultra'] = {
    ...
    displayInsights: [
      '2K 144Hz LTPO는 게이밍폰의 새로운 기준. 2600nit 실측은 경쟁사 2000-2200nit 대비 명확한 우위. 118% DCI-P3 + HDR10+ 영상미 우수.',
      '2160Hz 고주파 PWM 디밍 + 3200Hz 순간터치 샘플링은 게이머 체감을 극대화. 하지만 일반 사용자에게는 초과 기술.',
      'DSI +100 (전부 긍정): 디스플레이만으로는 현세대 최상위. 문제는 가격(5699元)과 타겟층 협소 때문이 아닌 디스플레이 탓이 아닐 것.'
    ],

    productInsights: [
      '활성냉각(Ice Dome)은 게이밍 성능 지속의 핵심. 36-43℃ 유지는 경쟁사의 45-48℃ 대비 명확한 우위. 하지만 풍냐 장기 신뢰성(5-7년 내구성)은 미확인 — 향후 1-2년 추적 필수.',
      '카메라 하드웨어(1인치급 부재, 50MP 스택)가 5699元 프리미엄을 정당화하지 못함. 게이밍폰 위치에 카메라 투자는 과도 판단. 야간 노이즈 처리도 미흡.',
      '가격 책정의 명확함: 게이머(방송인·프로)/스트리머 = ✅ 5699元 정당 / 일반사용자(99%) = ❌ iQOO 15(4199元) 권장. 지나친 이원화 전략 — 대중성 상실.'
    ],
